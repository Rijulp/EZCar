...
const CarDetails = ({ car, testDriveInfo }) => {
    ...
    // console.log("car.images.length:", car.images?.length);
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    {/* {car.images && car.images.length > 0 && (
                        <div className="flex gap-2 overflow-x-auto pb-2">
                            {car.images.slice(0, 3).map((image, index) => (
                                <div
                                    key={index}
                                    className="relative h-24 w-32 rounded-md overflow-hidden border border-gray-300"
                                >
                                    <Image
                                        src={image}
                ...
                <div className="w-full lg:w-5/12">
                    ...
                    <Dialog>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                <DialogTitle>EZCar Loan Calculator</DialogTitle>
